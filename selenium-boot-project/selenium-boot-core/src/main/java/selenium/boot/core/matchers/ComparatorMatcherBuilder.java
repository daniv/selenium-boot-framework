...
class ComparatorMatcherBuilder<T>
{
    ...
    {
        return new ComparatorMatcherBuilder<T>( Comparable:: compareTo, false );
    }
    ...
    {
        return new ComparatorMatcher<T>( comparator, value,
                                         ComparatorMatcher.EQUAL,
                                         ComparatorMatcher.EQUAL,
    ...
    private static final class ComparatorMatcher<T> extends TypeSafeMatcher<T>
    {
        ...
        private ComparatorMatcher( Comparator<T> comparator, T expected, int minCompare,
                                   int maxCompare, boolean includeComparatorInDescription )
        {
            this.comparator = comparator;
